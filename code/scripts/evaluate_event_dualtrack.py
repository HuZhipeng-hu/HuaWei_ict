...
def main() -> None:
    ...
    model_metrics = _attach_acceptance_flags(
        ...
        "release_command_clip_count": int(model_control.get("release_command_clip_count", 0)),
        ...
        algo_metrics = _attach_acceptance_flags(
            {
                ...
                "release_command_clip_count": int(algo_control.get("release_command_clip_count", 0)),
