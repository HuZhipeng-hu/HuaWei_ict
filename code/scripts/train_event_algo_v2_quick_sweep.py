...
def _build_presets() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "wrist_rule_min": 0.55,
            "wrist_rule_margin": 0.10,
            "release_emg_min": 0.38,
            "release_imu_max": 1.80,
        },
    ]
...
def main() -> None:
    ...
    for idx, preset in enumerate(_build_presets(), 1):
        ...
        cmd = [
            ...
            "--wrist_rule_min",
            str(float(preset["wrist_rule_min"])),
            "--wrist_rule_margin",
            str(float(preset["wrist_rule_margin"])),
            "--release_emg_min",
            str(float(preset["release_emg_min"])),
            "--release_imu_max",
            str(float(preset["release_imu_max"])),
            "--run_root",
            str(args.run_root),
            "--run_id",
            str(run_id),
